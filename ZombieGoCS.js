...
// event occurs, passing in the event and asskociated player profile data.
...
handlers.getCatalogItemInfo = function(args) {
  var itemID = args.itemId;
  
  var catalogItemsResponse = server.GetCatalogItems({});
  var catalogItems = catalogItemsResponse.Catalog;
  
  var itemInstance = catalogItems.find(function(catalogItem){
    return catalogItem.ItemId == itemID;
  });
  
  var itemEncodedData = itemInstance.CustomData;
  var itemUnEncodedData = JSON.parse(itemEncodedData);
  
  var WeaponType = itemUnEncodedData.WeaponType;
  var Damage = itemUnEncodedData.Damage;
  var CriticalDamage = itemUnEncodedData.CriticalDamage;
  var AttributeUtilized = itemUnEncodedData.AttributeUtilized;
  var SecondsBetweenStrikes = itemUnEncodedData.SecondsBetweenStrikes;
  var AttackDistance = itemUnEncodedData.AttackDistance;
  var PlayerAttributeType = itemUnEncodedData.PlayerAttributeType;
  
  return {
    itemID: itemID,
    itemDescription: itemInstance.Description,
    itemName: itemInstance.DisplayName,
   	weaponType: WeaponType,
    playerAttributeType: PlayerAttributeType,
    damage: Damage,
    criticalDamage: CriticalDamage,
    attributeUtilized: AttributeUtilized,
    secondsBetweenStrikes: SecondsBetweenStrikes,
    attackDistance: AttackDistance,
  };
}


handlers.AddItemToInventory = function(args){
